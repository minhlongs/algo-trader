...
npx ts-node scripts/send-email-campaign.ts
```
...
4. Include link to quant.cashclaw.cc
...
## Success Criteria
- [ ] Email campaign sent (check SendGrid)
- [ ] Blog post published
- [ ] Reddit post published on r/algotrading
- [ ] Twitter thread published
- [ ] Discord announcement posted
- [ ] All content uses correct links to quant.cashclaw.cc
