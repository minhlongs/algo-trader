...
vi.mock('../../../db/postgres-client', () => ({ query: mockQuery }));
vi.mock('../audit-validate', () => ({ mapRowToEntry: mockMapRowToEntry }));
vi.mock('../audit-hmac-key', () => ({ initHmacKey: mockInitHmacKey }));
vi.mock('../audit-hash-chain', () => ({ computeRowHash: mockComputeRowHash }));
