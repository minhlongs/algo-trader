-- 005-compliance-kyc-tables: Compliance and KYC tables for regulatory requirements
-- Applied via: npx wrangler d1 execute algo-trader-db --remote --file=migrations/005_compliance_kyc_tables.sql
