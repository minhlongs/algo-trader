...
vi.mock('../../notifications/alert-formatter', () => ({
  formatTelegramMessage: mockFormat,
}));

vi.mock('../bot-command-handlers', () => ({
...
type Service = typeof import('../bot').TelegramBotService;
type Mod = typeof import('../bot');
