...
import { applyCors, applySecurityHeaders, authenticateRequest, requireAdmin } from '../dashboard-middleware';
import type { IncomingMessage, ServerResponse } from 'node:http';
import { verifyJwt } from '../../api/auth-middleware';
...
vi.mock('../../../platform/api/auth-middleware', () => ({
