...
import { getDnaEngine, onDnaEvent, emitDnaEvent } from '../../strategies/dna/orchestrator.js';
import { getPaperJournal, clearPaperJournal } from '../../strategies/dna/paper-executor.js';
