...
function makeStrategy(overrides?: Parameters<typeof makeDeps>[0], config?: Partial<import('../correlation-breakdown').CorrelationBreakdownConfig>): CorrelationBreakdownStrategy {
