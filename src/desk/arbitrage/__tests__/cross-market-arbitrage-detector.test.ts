...
vi.mock('../integer-programming-solver', () => ({
  solveILP: mockSolveILP,
}));

vi.mock('../multi-leg-basket', () => ({
...
import { detectCrossMarketArbitrage, type MarketPrice } from '../cross-market-arbitrage-detector';
import { RelationType, type DependencyGraph } from '../../../shared/types/semantic-relationships';
