...
vi.mock('../alpha-candidates-handler', () => ({ handleCandidates: mockHandleCandidates }));
vi.mock('../alpha-discover-handler', () => ({ handleDiscover: mockHandleDiscover }));
vi.mock('../alpha-backtest-handler', () => ({ handleBacktest: mockHandleBacktest }));
vi.mock('../alpha-walkforward-handler', () => ({ handleWalkforward: mockHandleWalkforward }));
vi.mock('../alpha-compare-handler', () => ({ handleCompare: mockHandleCompare }));
vi.mock('../alpha-report-handler', () => ({ handleReport: mockHandleReport }));
vi.mock('../alpha-ablation-handler', () => ({ handleAblation: mockHandleAblation }));
vi.mock('../alpha-robustness-handler', () => ({ handleRobustness: mockHandleRobustness }));
