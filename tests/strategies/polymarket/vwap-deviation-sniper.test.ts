...
import {
  ...
  DEFAULT_CONFIG,
} from '../../../src/strategies/polymarket/vwap-deviation-sniper.ts';
...
describe('VWAP Deviation Sniper', () => {
  ...
  describe('Integration: Strategy Factory', () => {
    ...
    it('should create tick function with default config', async () => {
      const { createVwapDeviationSniperTick } = await import('../../../src/strategies/polymarket/vwap-deviation-sniper.ts');
  ...
  describe('Type Safety', () => {
    it('should have proper exports', async () => {
      const mod = await import('../../../src/strategies/polymarket/vwap-deviation-sniper.ts');
