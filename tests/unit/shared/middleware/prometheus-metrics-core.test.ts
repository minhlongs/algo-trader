...
vi.mock('../../../../src/shared/shared/utils/logger', () => ({
  logger: { debug: vi.fn(), info: vi.fn(), warn: vi.fn(), error: vi.fn() },
}));

type Mod = typeof import('../../../../src/shared/middleware/prometheus-metrics-core');
let mod: Mod;
...
beforeEach(async () => {
  ...
  mod = await import('../../../../src/shared/middleware/prometheus-metrics-core');
  vi.clearAllMocks();
});
