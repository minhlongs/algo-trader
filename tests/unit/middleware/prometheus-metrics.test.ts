...
describe('src/middleware/prometheus-metrics.ts', () => {
  ...
  describe('metricsMiddleware', () => {
    it('should call next()', async () => {
      const { metricsMiddleware } = await import('../../../src/middleware/prometheus-metrics');
    ...
    it('should increment counter and observe histogram on finish', async () => {
      const { metricsMiddleware, httpRequestsTotal, httpRequestDuration } = await import('../../../src/middleware/prometheus-metrics');
      await metricsMiddleware(req as Request, res as Response, next);
    ...
    it('should use req.route.path when available', async () => {
      ...
      const { metricsMiddleware, httpRequestsTotal } = await import('../../../src/middleware/prometheus-metrics');
      await metricsMiddleware(req as Request, res as Response, next);
  ...
  describe('getMetrics', () => {
    it('should return metrics from registry', async () => {
      const { getMetrics } = await import('../../../src/middleware/prometheus-metrics');
  ...
  describe('Legacy helper functions', () => {
    it('recordSignal should call qwenSignalsTotal.inc', async () => {
      const { recordSignal } = await import('../../../src/middleware/prometheus-metrics');
    ...
    it('recordExchangeLatency should call recordExternalApiLatency', async () => {
      const { recordExchangeLatency } = await import('../../../src/middleware/prometheus-metrics');
    ...
    it('recordTradeExecutionTime should call recordShardLatency', async () => {
      const { recordTradeExecutionTime } = await import('../../../src/middleware/prometheus-metrics');
    ...
    it('setWinRate should call winRatePercent.set', async () => {
      const { setWinRate } = await import('../../../src/middleware/prometheus-metrics');
      setWinRate(0.75);
    ...
    it('setCircuitBreakerState should call setCircuitBreakerState', async () => {
      const { setCircuitBreakerState } = await import('../../../src/middleware/prometheus-metrics');
    ...
    it('setOpenPositions should call setStrategyActive', async () => {
      const { setOpenPositions } = await import('../../../src/middleware/prometheus-metrics');
  ...
  describe('exports', () => {
    it('should export register', async () => {
      const mod = await import('../../../src/middleware/prometheus-metrics');
