...
let createRedisClusterClient: typeof import('../../../src/redis/cluster-config').createRedisClusterClient;
let getRedisClusterClient: typeof import('../../../src/redis/cluster-config').getRedisClusterClient;
let getClusterHealth: typeof import('../../../src/redis/cluster-config').getClusterHealth;
let closeRedisClusterClient: typeof import('../../../src/redis/cluster-config').closeRedisClusterClient;

beforeEach(async () => {
  vi.clearAllMocks();
  clusterCalls.length = 0;
  vi.resetModules();
  const mod = await import('../../../src/redis/cluster-config');
