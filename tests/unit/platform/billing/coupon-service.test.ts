...
import { CouponService } from '../../../../src/platform/billing/coupon-service';
import type { Coupon } from '../../../../src/platform/billing/coupon-service';

// Mock logger — must match the specifier the SUT imports
// (coupon-service.ts: `import { logger } from '../../../../src/platform/shared/utils/logger'`,
