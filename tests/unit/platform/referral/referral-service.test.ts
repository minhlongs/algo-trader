...
vi.mock('../../../../src/platform/referral/referral-repository', () => ({ referralRepository: mockRepo }));
vi.mock('../../../../src/platform/referral/commission-calculator', () => ({ commissionCalculator: mockCalc }));
...
vi.mock('../../../../src/platform/referral/fraud-detector', () => ({
  fraudDetector: mockFraud,
  FraudDetector: MockFraudDetector,
}));

import { ReferralService } from '../../../../src/platform/referral/referral-service';
