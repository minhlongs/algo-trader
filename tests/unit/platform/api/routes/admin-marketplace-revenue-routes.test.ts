...
vi.mock('../../../../../src/platform/marketplace/services/revenue.service', () => ({
...
import { registerMarketplaceRevenueRoutes } from '../../../../../src/platform/api/routes/admin-marketplace-revenue-routes';
