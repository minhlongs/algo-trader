...
vi.mock('../../../../../src/platform/raas/subscriber-pnl-aggregator', () => ({
...
vi.mock('../../../../../src/platform/raas/subscriber-equity-curve-builder', () => ({
  SubscriberEquityCurveBuilder: class {
    build = equityBuildMock;
  },
}));

vi.mock('../../../../../src/platform/raas/subscriber-activity-metrics', () => ({
...
import { subscriberPnlRouter } from '../../../../../src/platform/api/routes/subscriber-pnl-routes';
