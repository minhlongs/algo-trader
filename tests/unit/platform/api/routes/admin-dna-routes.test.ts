...
vi.mock('../../../../../src/desk/strategies/dna/orchestrator', () => ({
...
vi.mock('../../../../../src/desk/strategies/dna/dna-state-store', () => ({
...
import { createAdminDnaRouter, setDnaProvider, setDnaConfig, resetDnaProvider } from '../../../../../src/platform/api/routes/admin-dna-routes';
...
describe('Admin DNA Routes', () => {
  ...
  describe('GET /status with full engine state', () => {
    it('maps _lastTfSignals into lastTfSignals array (line 45)', async () => {
      ...
      const { getDnaEngine } = await import('../../../../../src/desk/strategies/dna/orchestrator');
  ...
  describe('error catch blocks', () => {
    ...
    it('POST /start returns 500 when startDnaEngine throws (line 90)', async () => {
      const { startDnaEngine } = await import('../../../../../src/desk/strategies/dna/orchestrator');
    ...
    it('POST /stop returns 500 when stopDnaEngine throws (line 105)', async () => {
      const { stopDnaEngine } = await import('../../../../../src/desk/strategies/dna/orchestrator');
    ...
    it('POST /reset returns 500 when resetDnaEngine throws (line 120)', async () => {
      const { resetDnaEngine } = await import('../../../../../src/desk/strategies/dna/orchestrator');
