...
import { StrategyRepository } from '../../../../../src/platform/marketplace/repositories/strategy-repository';
...
describe('StrategyRepository', () => {
  ...
  describe('singleton export', () => {
    it('exports strategyRepository instance', async () => {
      const { strategyRepository } = await import('../../../../../src/platform/marketplace/repositories/strategy-repository');
