...
import { DisputeRepository } from '../../../../src/platform/marketplace/repositories/dispute-repository';
...
describe('DisputeRepository', () => {
  ...
  describe('singleton export', () => {
    it('exports disputeRepository instance', async () => {
      const { disputeRepository } = await import('../../../../src/platform/marketplace/repositories/dispute-repository');
