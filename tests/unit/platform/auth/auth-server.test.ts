...
vi.mock('../../../../src/platform/billing/trial-drip-service', () => ({
...
describe('auth-server', () => {
  ...
  describe('configuration shape', () => {
    it('calls betterAuth with all required top-level keys', async () => {
      await import('../../../../src/platform/auth/auth-server');
  ...
  describe('auth export', () => {
    it('exports a defined auth instance', async () => {
      const module = await import('../../../../src/platform/auth/auth-server');
  ...
  describe('production validation', () => {
    it('throws when BETTER_AUTH_SECRET is missing in production', async () => {
      ...
      await expect(import('../../../../src/platform/auth/auth-server')).rejects.toThrow(
