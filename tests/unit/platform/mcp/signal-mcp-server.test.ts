...
import { __setGate } from '../../../../src/platform/middleware/signal-tier-resolver';
...
vi.mock('../../../../src/platform/signal/signal-subscriber-repository-d1', () => ({
...
import type { TierKey } from '../../../../src/platform/desk/signal/signal-types';
...
describe('signal-mcp-server', () => {
  ...
  describe('runSignalMcpServer', () => {
    it('is exported and callable', async () => {
      ...
      const { runSignalMcpServer } = await import('../../../../src/platform/mcp/signal-mcp-server');
