...
let WhaleActivityFeed: typeof import('../../../../src/desk/feeds/whale-activity-feed').WhaleActivityFeed;
let startWhaleActivityFeed: typeof import('../../../../src/desk/feeds/whale-activity-feed').startWhaleActivityFeed;

async function importFeed() {
  const mod = await import('../../../../src/desk/feeds/whale-activity-feed');
