...
vi.mock('../../../../src/platform/notifications/email-service', () => ({
...
import { registerDripRecipient, processDripQueue } from '../../../../src/desk/jobs/welcome-email-drip';
import { readJson, writeJson } from '../../../../src/shared/persistence/persistent-store';
