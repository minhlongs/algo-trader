...
vi.mock('../../../../../src/desk/strategies/polymarket/delta-calculator', () => ({
  computePortfolioDelta: mockComputeDelta,
  computePortfolioPnl: mockComputePnl,
}));

vi.mock('../../../../../src/desk/strategies/polymarket/rebalance-engine', () => ({
  requiresRebalance: mockRequiresRebalance,
  computeRebalanceSignals: mockComputeSignals,
  applyRebalanceSignals: mockApplySignals,
}));

type Mod = typeof import('../../../../../src/desk/strategies/polymarket/delta-neutral-portfolio-monitor');
let mod: Mod;
...
beforeEach(async () => {
  ...
  vi.resetModules();
  mod = await import('../../../../../src/desk/strategies/polymarket/delta-neutral-portfolio-monitor');
});
