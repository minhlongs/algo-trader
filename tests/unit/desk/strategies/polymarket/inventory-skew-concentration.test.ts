...
import { runConcentrationCheck } from '../../../../../src/desk/strategies/polymarket/inventory-skew-concentration';
import type { ConcentrationContext } from '../../../../../src/desk/strategies/polymarket/inventory-skew-concentration';
import type { OrderManager, EventBus } from '../../../../../src/desk/strategies/polymarket/order-manager';
import type { TrackedPosition, InventorySkewRebalancerConfig } from '../../../../../src/desk/strategies/polymarket/inventory-skew-types';
...
async function runConcentrationCheckWithCustomOrderManager(ctx: ConcentrationContext, customOrderManager: OrderManager): Promise<void> {
  const { runConcentrationCheck: runCheck } = await import('../../../../../src/desk/strategies/polymarket/inventory-skew-concentration');
