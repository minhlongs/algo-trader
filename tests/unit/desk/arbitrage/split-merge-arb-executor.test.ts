...
vi.mock('../../../../src/desk/arbitrage/wiring/paper-trading-orchestrator', () => ({
...
describe('SplitMergeArbExecutor - Coverage', () => {
  let scanSplitMergeArb: typeof import('../../../../src/desk/arbitrage/split-merge-arb-executor').scanSplitMergeArb;
  let executePaperSplitMerge: typeof import('../../../../src/desk/arbitrage/split-merge-arb-executor').executePaperSplitMerge;
  let fetchAndScanSplitMerge: typeof import('../../../../src/desk/arbitrage/split-merge-arb-executor').fetchAndScanSplitMerge;
  ...
  beforeEach(async () => {
    ...
    const mod = await import('../../../../src/desk/arbitrage/split-merge-arb-executor');
