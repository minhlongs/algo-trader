...
vi.mock('../../../../src/desk/risk/position-validation', () => ({
  validateExposureLimits: mockValidateExposureLimits,
  buildExposureSummary: mockBuildExposureSummary,
}));

import { PositionManager } from '../../../../src/desk/risk/position-manager';
import type { ExposureSummary } from '../../../../src/desk/risk/position-manager-types';
