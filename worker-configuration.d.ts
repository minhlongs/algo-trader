/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db898f97a496c7fc2916c1f17e0e1950)
// Runtime types generated with workerd@1.20260611.1 2024-12-01 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "us-east" | "eu-central" | "ap-southeast" | "production";
	NODE_ENV: string;
	LOG_LEVEL: string;
	DB_PATH: string;
	...
	POLAR_BENEFIT_ENTERPRISE: string;
	POLYMARKET_API_KEY: string;
	POLYMARKET_API_SECRET: string;
	POLYMARKET_PASSPHRASE: string;
	OPENCLAW_GATEWAY_URL: string;
	OPENCLAW_SCANNER_URL: string;
	OPENCLAW_MODEL_SIMPLE: string;
	OPENCLAW_MODEL_STANDARD: string;
	OPENCLAW_MODEL_COMPLEX: string;
	OPENCLAW_TIMEOUT_MS: string;
	QWEN_SERVER_URL: string;
	QWEN_MODEL: string;
	QWEN_INGEST_HMAC_SECRET: string;
	QWEN_SIGNAL_INGEST_URL: string;
	QWEN_SIGNAL_KILL: string;
	QWEN_KILL: string;
	QWEN_LIVE_ELIGIBLE: string;
	QWEN_AUTO_APPROVE_MAX_USD: string;
	QWEN_DRAWDOWN_MAX_PCT: string;
	DATABASE_PATH: string;
	PAPER_TRADING: string;
	CAPITAL_USDC: string;
	LICENSE_ACTIVATION_SECRET: string;
	...
	CACHE?: KVNamespace;
	HYPERDRIVE_POLYMARKET?: Hyperdrive;
	HYPERDRIVE_LLM_GATEWAY?: Hyperdrive;
	HYPERDRIVE_EXCHANGE_API?: Hyperdrive;
	SHARD_MANAGER?: DurableObjectNamespace /* ShardManager */;
	SHARD_0?: DurableObjectNamespace /* StrategyShard */;
	SHARD_1?: DurableObjectNamespace /* StrategyShard */;
	SHARD_2?: DurableObjectNamespace /* StrategyShard */;
	SHARD_3?: DurableObjectNamespace /* StrategyShard */;
	SHARD_4?: DurableObjectNamespace /* StrategyShard */;
	SHARD_5?: DurableObjectNamespace /* StrategyShard */;
	SHARD_6?: DurableObjectNamespace /* StrategyShard */;
	SHARD_7?: DurableObjectNamespace /* StrategyShard */;
	SHARD_8?: DurableObjectNamespace /* StrategyShard */;
	SHARD_9?: DurableObjectNamespace /* StrategyShard */;
	SHARD_10?: DurableObjectNamespace /* StrategyShard */;
	SHARD_11?: DurableObjectNamespace /* StrategyShard */;
}
declare namespace Cloudflare {
	...
	interface ApSoutheastEnv {
		ENVIRONMENT: "ap-southeast";
		REGION_ROUTING_ENABLED: "true";
		NODE_ENV: string;
		LOG_LEVEL: string;
		DB_PATH: string;
