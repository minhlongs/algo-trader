...
export default {
  ...
  login: {
    ...
    signInTitle: 'Sign in to CashClaw',
    email: 'Email',
    password: 'Password',
    emailPlaceholder: 'you@example.com',
    passwordPlaceholder: '••••••••',
  ...
  settings: {
    ...
    mmConfigDescription: 'Market making strategy configuration. Changes take effect on next requote cycle.',
    saveParameters: 'Save Parameters',
    savingParams: 'Saving…',
    saved: 'Saved',
    backendNotConfigured: 'Backend not configured — changes not persisted',
    dismiss: 'Dismiss',
    keyCreationFailed: 'Backend unreachable. Cannot create API key. Please ensure the API server is running and try again.',
  },
  ...
  account: {
    ...
    maxPositionSize: 'Max position size',
    apiKey: 'API Key',
    apiKeyDescription: 'Use this key to authenticate CLI and programmatic access.',
    regenerate: 'Regenerate',
    regenerationDisabled: 'Key regeneration is disabled. Contact support to rotate your key.',
    contactSupport: 'Contact support',
    billing: 'Billing',
    freePlan: "You're on the free plan.",
    upgrade: 'Upgrade',
    upgradeManage: 'Upgrade / Manage →',
    activeSubscription: 'Active {{tier}} subscription.',
