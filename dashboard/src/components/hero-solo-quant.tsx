    ...
    <section className="pt-32 pb-16 px-4 sm:px-6 max-w-5xl mx-auto">
      <div className="flex flex-col items-start gap-6">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold leading-[1.05] tracking-tight text-white">
          Solo Quant Desk —
          <br />
          <span className="text-[${_COLORS.primary}]">Live on Polymarket</span>
        </h1>
        <h2 className="text-[${_COLORS.onSurfaceVariant}] text-lg sm:text-xl leading-relaxed max-w-2xl">
          One human. Zero overhead. Open methodology.
        </h2>
        <p className="text-[${_COLORS.onSurfaceVariant}]/80 text-sm sm:text-base leading-relaxed max-w-2xl">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <a
            ...
            className="bg-[${_COLORS.primary}] text-[${_COLORS.surface}] font-bold px-6 py-3 rounded hover:bg-[${_COLORS.primary}]/80 transition-colors text-sm min-h-touch inline-flex items-center"
          >
            Read Methodology
          </a>
          <Link
            to="/manifesto"
            className="border border-[${_COLORS.surface}] text-[${_COLORS.onSurfaceVariant}] hover:text-white hover:border-[${_COLORS.primary}]/50 font-semibold px-6 py-3 rounded transition-colors text-sm min-h-touch inline-flex items-center"
          >
            Read Manifesto
          </Link>
        </div>
