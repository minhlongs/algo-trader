  ...
  return (
    <section id="daily-ops">
      ...
      <div className="space-y-6">
        {/* Status Check */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">Check status</p>
          <CopyBlock code="pm2 status" />
        </div>

        {/* View Logs */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">View logs</p>
          <CopyBlock code="pm2 logs cashclaw --lines 30" />
        </div>

        {/* Check Portfolio */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">Check portfolio</p>
        ...
        {/* Update Bot */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">Update to latest version</p>
...
pm2 restart cashclaw`} />
        ...
        {/* Daily Log */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">Daily log template</p>
...
# Notes:`} />
        ...
        {/* Dashboard */}
        <div>
          <p className="text-xs font-mono text-[#00C8E8] uppercase tracking-widest mb-2">Dashboard</p>
          <p className="text-sm font-mono text-[#8892B0]">
