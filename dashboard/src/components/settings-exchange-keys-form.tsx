    ...
    <>
      ...
      {newKeyVisible && (
        <div className="bg-profit/10 border border-profit/30 rounded p-3 mb-2">
          ...
          <code className="text-white text-xs break-all">{newKeyVisible}</code>
          <button
      ...
      <div className="space-y-2">
        ...
        {apiKeys.map((k) => (
          ...
          >
            <div>
              <code className="text-white text-xs">{k.maskedKey}</code>
            ...
            <button
              ...
              className="text-loss text-xs hover:underline"
            >
              Revoke
            </button>
          </div>
