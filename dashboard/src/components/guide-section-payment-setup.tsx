...
export function GuidePricing() {
  return (
    <section id="pricing">
      <h2 className="text-xl font-bold text-white mb-4">Pricing & Payment</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-[#111627] border border-[#1E2640] rounded-lg p-4">
            ...
            <p className="text-[#F59E0B] font-bold text-2xl mb-3">$49<span className="text-sm text-[#8892B0]">/mo</span></p>
          ...
          <div className="bg-[#111627] border-2 border-[#F59E0B] rounded-lg p-4 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#F59E0B] text-[#0D1117] px-3 py-0.5 rounded-full text-xs font-bold">
              Popular
            </div>
            <p className="text-white font-bold text-lg mb-1">Pro</p>
            <p className="text-[#F59E0B] font-bold text-2xl mb-3">$149<span className="text-sm text-[#8892B0]">/mo</span></p>
            <ul className="text-xs text-[#8892B0] space-y-1">
        ...
        <div>
          ...
          <div className="bg-[#111627] border border-[#1E2640] rounded-lg p-4 text-sm text-[#8892B0] space-y-2">
            <p>1. Go to <span className="text-[#F59E0B]">cashclaw.cc</span> &rarr; Pricing section</p>
        ...
        <div>
          ...
          <p className="text-sm text-[#8892B0]">
            Enter your coupon code on the <span className="text-[#F59E0B]">cashclaw.cc</span> pricing page
