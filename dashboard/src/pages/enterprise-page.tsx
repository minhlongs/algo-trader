/**
 * Enterprise Page — consolidated pricing + contact in one view.
 * Tab navigation: "Pricing" | "Contact"
...
const FAQS = [
  {
    ...
    a: 'Enterprise plans are billed monthly via invoice. No credit card or self-serve checkout — our team sends a custom proposal after the discovery call.',
  },
  {
  ...
  },
  {
    ...
    a: 'PRO: next-business-day response. ENTERPRISE: 4-hour response. MASTER: 1-hour response with 99.9% uptime commitment.',
  },
  {
    q: 'Is a custom contract available?',
    a: 'Yes. All enterprise plans include a custom MSA. BAA and DPA available on MASTER tier.',
  },
];
...
function ContactTab({ defaultTier }: { defaultTier: EnterprisePlanKey }) {
...
const NEXT_STEPS = [
  {
    title: 'Account team assignment (today)',
    desc: 'An Account Manager is notified and will claim your inquiry.',
  },
  {
    title: 'Intro call (within 24 h)',
    desc: 'Your Account Manager schedules a 30-minute discovery call to understand your requirements.',
  },
  {
    ...
    <div className="min-h-screen bg-bg text-white flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-16 px-4 sm:px-6 max-w-6xl mx-auto w-full">
        ...
        {activeTab === 'pricing' ? (
          ...
          <ContactTab defaultTier={selectedTier} />
        )}
      </main>
