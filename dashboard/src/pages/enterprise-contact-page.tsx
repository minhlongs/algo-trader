      ...
      <main className="flex-1 pt-24 pb-16 px-4 sm:px-6 max-w-xl mx-auto w-full">
        ...
        <form onSubmit={(e) => { void handleSubmit(e); }} className="space-y-5">
                ...
                <button
                  ...
                  className={`p-3 rounded border text-xs text-left transition-colors ${
                    fields.tier === key
                      ...
                      : 'border-[#2D3142] text-[#8892B0] hover:border-[#00D9FF]/40'
                  }`}
                >
          ...
          <button
            ...
            className="w-full bg-[#00D9FF] text-[#0F0F1A] font-bold py-3 rounded hover:bg-[#00D9FF]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
...
const inputCls =
  'w-full bg-[#161A1E] border border-[#2D3142] text-white text-sm rounded px-3 py-2.5 outline-none focus:border-[#00D9FF]/60 transition-colors placeholder-[#555]';
